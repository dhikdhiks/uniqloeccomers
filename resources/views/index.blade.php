        ...
        <div class="swiper-slide">
            <div class="overflow-hidden position-relative h-100">
                ...
                <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                    ...
                    <h2 class="h1 fw-normal mb-0 animate animate_btt animate_delay-5">{{ $slide->title }}</h2>
...
<style>
/* Ensure only the active slide's text is visible */
.swiper-slide:not(.swiper-slide-active) .slideshow-text {
    opacity: 0;
    visibility: hidden;
    transition: opacity 0.3s ease, visibility 0.3s ease;
}

.swiper-slide.swiper-slide-active .slideshow-text {
    opacity: 1;
    visibility: visible;
}

/* Reset animation classes for inactive slides */
.swiper-slide:not(.swiper-slide-active) .animate {
    animation: none;
}

/* Ensure the slideshow container has a defined height */
.js-swiper-slider {
