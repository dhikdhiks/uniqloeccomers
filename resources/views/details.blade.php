        ...
        <div class="col-lg-5">
          <div class="d-flex justify-content-between mb-4 pb-md-2">
            ...
            <div
              ...
              <a href="{{ url("#") }}" class="text-uppercase fw-medium"><svg width="10" height="10" viewBox="0 0 25 25"
                  xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_prev_md" />
                </svg><span class="menu-link menu-link_us-s">Prev</span></a>
              <a href="{{ url("#") }}" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">Next</span><svg
          ...
          <div class="product-single__meta-info">
            ...
            <div class="meta-item d-flex align-items-center gap-2">
                ...
                @if ($product->brand && $product->brand->image)
                    <img src="{{ asset('/uploads/brands/' . $product->brand->image) }}" alt="{{ $product->brand->name }}"
                         class="img-fluid" style="height: 32px; width: auto;">
                @endif
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item" role="presentation">
            <a class="nav-link nav-link_underscore active" id="tab-description-tab" data-bs-toggle="tab"
              href="{{ url("#tab-description") }}" role="tab" aria-controls="tab-description" aria-selected="true">Description</a>
          </li>
          <li class="nav-item" role="presentation">
            <a class="nav-link nav-link_underscore" id="tab-additional-info-tab" data-bs-toggle="tab"
              href="{{ url("#tab-additional-info") }}" role="tab" aria-controls="tab-additional-info"
              aria-selected="false">Additional Information</a>
          </li>
          <li class="nav-item" role="presentation">
            <a class="nav-link nav-link_underscore" id="tab-reviews-tab" data-bs-toggle="tab" href="{{ url("#tab-reviews") }}"
        ...
        <div class="swiper-slide product-card">
          <div class="pc__img-wrapper">
            <a href="{{ route('shop.product.details', ['product_slug' => $rproduct->slug]) }}">
              ...
              @php $images = explode(",", $rproduct->images); @endphp
              @if (isset($images[1]))
                <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $images[1] }}" width="330" height="400" alt="{{ $rproduct->name }}" class="pc__img pc__img-second">
              @endif
            </a>
          ...
          <div class="pc__info position-relative">
            ...
            <div class="product-card__price d-flex">
              <span class="money price">
                @if ($rproduct->sale_price)
                  <s>IDR {{ number_format($rproduct->regular_price, 0, ',', '.') }}</s>
                  IDR {{ number_format($rproduct->sale_price, 0, ',', '.') }}
                @else
                  IDR {{ number_format($rproduct->regular_price, 0, ',', '.') }}
                @endif
              </span>
            </div>
            ...
            <form method="POST" action="{{ route('wishlist.remove', ['rowId' => Cart::instance('wishlist')->content()->where('id', $rproduct->id)->first()->rowId]) }}" id="frm-remove-item-{{ $rproduct->id }}">
              @csrf
              @method('DELETE')
              <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart position-absolute top-0 end-0" onclick="document.getElementById('frm-remove-item-{{ $rproduct->id }}').submit();" title="Remove from Wishlist">
                <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_heart" />
                </svg>
              </a>
            ...
            @else
            <form method="POST" action="{{ route('wishlist.add') }}" id="wishlist-form-{{ $rproduct->id }}">
              @csrf
              <input type="hidden" name="id" value="{{ $rproduct->id }}" />
              <input type="hidden" name="name" value="{{ $rproduct->name }}" />
              <input type="hidden" name="price" value="{{ $rproduct->sale_price ?: $rproduct->regular_price }}" />
              <input type="hidden" name="quantity" value="1" />
              <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist position-absolute top-0 end-0" onclick="document.getElementById('wishlist-form-{{ $rproduct->id }}').submit();" title="Add to Wishlist">
                <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_heart" />
                </svg>
              </a>
