      ...
      <div class="row pt-5 mt-5">
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__addtolinks">
            <a href="{{ url("#") }}" class="menu-link menu-link_us-s add-to-wishlist"><svg width="16" height="16" viewBox="0 0 20 20"
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                ...
                <input type="hidden" name="price" value="{{$rproduct->sale_price == '' ? $rproduct->reqular_price : $product->sale_price}}" />
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{route('shop.product.details', ['product_slug' => $rproduct->slug]) }}"></a>{{$rproduct->name}}</h6>
